  ...
  return (
    <Contactus>
      <div className="mainaboutus">
        ...
        <h1>{t("ContactUs")}</h1>
        <span>{t("HereToHelpWithBankingNeeds")}</span>
      </div>

      <div className="contactform">
        <div className="firsdiv">
          <form action="">
            <h1 className="h1sendmes">{t("SendUsAMessage")}</h1>
          ...
          <div className="intouhbox">
            ...
            <div className="boxs">
              ...
              <div className="the writeips">
                ...
                <span>{t("ResponseWithin24Hours")}</span>
              </div>
            </div>
      ...
      <div className="locationmap">
        <div className="find">
          <p>{t("FindOurLocations")}</p>
          <span>{t("VisitOurBranches")}</span>
        </div>
        <iframe
...

{
  ...
  <div className="contactform">
    ...
    <div className="seconddiv">
      <h1>Get in Touch</h1>
      <p>
        Have questions about our services? Need help with your account? Our team
  ...
  <div className="locationmap">
    <div className="find">
      ...
      <span>Visit any of our convenient bBRANCH locations</span>
    </div>
    <iframe
      src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d24191.63546718769!2d-74.02853380251251!3d40.71901958746316!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1s123%20banking%20street%20financial%20district%20new%20york%20ny%2010001!5e0!3m2!1sen!2sng!4v1768820273730!5m2!1sen!2sng"
      width="100%"
