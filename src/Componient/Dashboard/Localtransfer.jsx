...
const Wiretransfer = () => {
  ...
  const handleTransferSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://geochain.app/southvent/api/transfers/", {
        method: "POST",
        headers: {
      ...
      <div className="profilewrapper">
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              placeholder={t("ReceiverAccount")}
              required
            />
          </div>

          <div>
            <label>{t("ReceiverFullName")}</label>
            <input
              value={receiverName}
          ...
          <div>
            <label>{t("ReceiverBank")}</label>
            <input
              value={receiverBank}
              onChange={(e) => setReceiverBank(e.target.value)}
              placeholder={t("ReceiverBank")}
              required
            />
          </div>

          <div>
            <label>{t("RoutingNumberOne")}</label>
            <input
              maxLength={9}
              value={swiftCode}
              onChange={(e) => setSwiftCode(e.target.value)}
              placeholder={t("RoutingNumberTwo")}
              required
            />
          </div>

          <div>
            <label>{t("ReceiverNumber")}</label>
          ...
          <div>
            <label>{t("PurposeofTransfer")}</label>
            <input
              value={purpose}
              onChange={(e) => setPurpose(e.target.value)}
              placeholder={t("PurposeofTransfer")}
            />
          </div>
        ...
        {showCodeModal && (
          <div className="otp-modal">
            {messages && (
              <p className="messageshow">{t("transferSuccessMessage")}</p>
            )}
            ...
            <div className="livdivs">
              <div className="close">
                <h3>
                  {t("CodeRequired")}{" "}
                  <span>{getCodeLabel(currentCodeType)}</span>
                </h3>
              ...
              <h4>
                {t("enterCodeMessage", {
                  codeType: getCodeLabel(currentCodeType),
                })}
